var Modal = (function (e) {
  ...
  function (e, t, n) {
    ...
    function d(e, t) {
      return e.nodeName
        ? e
        : ((e = e.replace(/(\t|\n$)/g, "")), (m.innerHTML = ""), (m.innerHTML = e), !0 === t ? m.childNodes : m.childNodes[0]);
    }
    function c(e) {
          ...
          h(t, null, [
            {
              ...
              value: function (e) {
                ...
                return new t(u({}, y, { title: e, content: !1, construct: !0, headerClose: !1, buttons: t.buttons.alert }, n));
              },
            },
            {
              key: "confirm",
              value: function (e) {
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                return new t(u({}, y, { title: e, content: !1, construct: !0, headerClose: !1, buttons: t.buttons.confirm }, n));
              },
            },
            {
              key: "templates",
          ...
          h(t, [
              ...
              value: function () {
                ...
                t.header &&
                  ...
                  (t.title.nodeName
                    ...
                    : "string" == typeof t.title && (e.header.innerHTML = '<h4 class="modal-title">' + t.title + "</h4>"),
                  null === this.el && e.headerClose && t.headerClose && e.header.insertBefore(e.headerClose, e.header.firstChild),
            ...
            },
            {
              ...
              value: function () {
                ...
                t.content &&
                  e.body &&
                  ("string" == typeof t.content ? (e.body.innerHTML = t.content) : (e.body.innerHTML = t.content.outerHTML),
                ...
                c(e.target).every(function (n) {
                  return !(
                    ...
                    ("modal" === n.getAttribute("data-dismiss")
                      ...
                      : n.classList.contains("modal") && (t.emit("dismiss", t, e, null), t.hide(), 1))
                  );
                });
              },
            },
            ...
            },
            {
              ...
              value: function () {
                ...
                (this._html.container.style.paddingLeft = !this.bodyIsOverflowing && e ? _ + "px" : ""),
                  (this._html.container.style.paddingRight = this.bodyIsOverflowing && !e ? _ + "px" : "");
              },
            },
            {
              key: "_backdrop",
            ...
            },
            {
              key: "_removeEvents",
              value: function () {
                this._events.keydownHandler && document.body.removeEventListener("keydown", this._events.keydownHandler),
    ...
    (e.exports = n),
      ...
      (n.prototype.emit = function (e) {
        ...
        if (i(n))
          ...
          for (a = Array.prototype.slice.call(arguments, 1), d = n.slice(), o = d.length, l = 0; l < o; l++) d[l].apply(this, a);
        return !0;
      }),
